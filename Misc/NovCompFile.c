...
#pragma config(Motor,  port2,           left1,         tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_4, 1000)
...
#pragma config(Motor,  port8,           right1,        tmotorVex393, openLoop, encoder, encoderPort, I2C_3, 1000)
...
task usercontrol()
{
	...
	// INTAKE
		...
		if(vexRT[Btn8R] == 0)
		{
			...
			{
					/* What we used to use for motor temp */
