...
#pragma config(Motor,  port8,           driveLeft,     tmotorVex393, openLoop, encoder, encoderPort, I2C_3, 1000)
...
#pragma config(Motor,  port5,           right1,        tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_1, 1000)
...
float            target_velocityR;        ///< target_velocity velocity
float            target_velocityL;
...
float            first_crossR;            ///< flag indicating first zero crossing RIGHT
float            first_crossL;            /// LEFT
