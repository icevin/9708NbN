...
#pragma config(Motor,  port2,           left1,         tmotorVex393, openLoop, encoder, encoderPort, None, 1000)
#pragma config(Motor,  port3,           left2,         tmotorVex393, openLoop)
#pragma config(Motor,  port4,           driveLeft2,    tmotorVex393, openLoop)
#pragma config(Motor,  port5,           driveLeft,     tmotorVex393, openLoop, encoder, encoderPort, None, 1000)
#pragma config(Motor,  port6,           driveRight,    tmotorVex393, openLoop, reversed, encoder, encoderPort, None, 1000)
#pragma config(Motor,  port7,           driveRight2,   tmotorVex269, openLoop, reversed)
#pragma config(Motor,  port8,           right1,        tmotorVex393, openLoop, reversed, encoder, encoderPort, None, 1000)
...
//INTAKE
		...
		if(abs(vexRT[Ch2Xmtr2]) > deadzone)
		{
			motor[up] = vexRT[Ch2Xmtr2];  // start UP
		}
		else
		{
			motor[up] = 0;  // stop UP
