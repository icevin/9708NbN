...
#pragma config(Motor,  port1,           driveLeft2,    tmotorVex393, openLoop)
...
#pragma config(Motor,  port8,           right1,        tmotorVex393, openLoop, reversed, encoder, encoderPort, dgtl3, 1000)
#pragma config(Motor,  port9,           right2,        tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port10,          driveRight2,   tmotorVex393, openLoop, reversed)
